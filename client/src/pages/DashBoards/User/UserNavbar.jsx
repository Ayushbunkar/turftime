...
const UserNavbar = ({ onMobileMenuToggle, onToggleDark, darkMode = false }) => {
  ...
  const fetchNotifications = async () => {
    try {
      ...
      setNotifications([
        { id: 1, message: 'Booking confirmed for tomorrow', type: 'success', time: '5 min ago' },
        { id: 2, message: 'New turf available in your area', type: 'info', time: '1 hour ago' },
        { id: 3, message: 'Payment successful', type: 'success', time: '2 hours ago' }
      ]);
    } catch (error) {
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden lg:flex items-center space-x-6 text-sm text-gray-600 dark:text-gray-300">
            <div className="flex items-center space-x-1">
              ...
              <span className="font-medium">{quickStats.upcomingBookings}</span>
              <span>Upcoming</span>
            </div>
            <div className="flex items-center space-x-1">
              <CreditCard className="w-4 h-4 text-purple-500" />
              <span className="font-medium">{quickStats.totalBookings}</span>
              <span>Total</span>
            </div>
            <div className="flex items-center space-x-1">
              <Star className="w-4 h-4 text-yellow-500" />
              <span className="font-medium">{quickStats.rewardPoints}</span>
              <span>Points</span>
            </div>
          </div>
